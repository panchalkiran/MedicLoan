...
public class DoctorWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public DoctorWorkAreaJPanel(JPanel container, UserAccount ua, Organization organization, Enterprise enterprise,EcoSystem system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(machineDetails);
        machineDetails.setBounds(400, 310, 550, 220);
        ...
        add(btnBuy);
        btnBuy.setBounds(1040, 290, 180, 50);
        ...
        btnPayInstallment.setBounds(1040, 500, 180, 50);
        ...
        add(btnViewDet);
        btnViewDet.setBounds(50, 310, 180, 50);
        ...
        add(btnNotifyTech);
        btnNotifyTech.setBounds(1040, 360, 180, 50);
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(30, 80, 1170, 190);
        ...
        add(btnSuggestion);
        btnSuggestion.setBounds(1040, 430, 180, 50);
    ...
    private void btnBuyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuyActionPerformed
        ...
        container.add("Doctor Buy A Machine JPanel", addcartjp);
    ...
    private void btnPayInstallmentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPayInstallmentActionPerformed
        ...
        container.add("Doctor Pay Installment JPanel", payInstallmentjp);
        CardLayout layout = (CardLayout) container.getLayout();
        layout.next(container);
    ...
    private void btnNotifyTechActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNotifyTechActionPerformed
        ...
        if (selectedrow >= 0) {
            ...
            if (machineReq.getStatus().equals("Completed")) {
                ...
                container.add("Doctor Call Technician JPanel", calltechjp);
                CardLayout layout = (CardLayout) container.getLayout();
                layout.next(container);
            } else {
    ...
    private void btnSuggestionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuggestionActionPerformed
        ...
        container.add("Doctor Suggestion JPanel", suggJP);
        CardLayout layout = (CardLayout) container.getLayout();
        layout.next(container);
