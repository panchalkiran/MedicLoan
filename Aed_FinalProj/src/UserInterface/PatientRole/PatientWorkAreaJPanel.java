...
public class PatientWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public PatientWorkAreaJPanel(JPanel container, UserAccount ua, Organization organization, Enterprise enterprise,EcoSystem system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblDoctor.setText("Patient");
        add(lblDoctor);
        lblDoctor.setBounds(72, 15, 100, 16);
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(30, 90, 1170, 190);
        ...
        add(btnViewDet);
        btnViewDet.setBounds(50, 320, 180, 50);
        ...
        add(machineDetails);
        machineDetails.setBounds(400, 320, 550, 220);
        ...
        add(btnBuy);
        btnBuy.setBounds(1040, 300, 180, 50);
        ...
        add(btnNotifyTech);
        btnNotifyTech.setBounds(1040, 370, 180, 50);
        ...
        add(btnSuggestion);
        btnSuggestion.setBounds(1040, 440, 180, 50);
        ...
        btnPayInstallment.setBounds(1040, 510, 180, 50);
    ...
    private void btnBuyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuyActionPerformed
        ...
        container.add("Patient Buy A Machine JPanel", addcartjp);
    ...
    private void btnNotifyTechActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNotifyTechActionPerformed
        ...
        if (selectedrow >= 0) {
            ...
            if (machineReq.getStatus().equals("Completed")) {
                ...
                container.add("Patient Call Technician JPanel", calltechjp);
                CardLayout layout = (CardLayout) container.getLayout();
                layout.next(container);
            } else {
    ...
    private void btnSuggestionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuggestionActionPerformed
        ...
        container.add("Patient Suggestion JPanel", suggJP);
        CardLayout layout = (CardLayout) container.getLayout();
        layout.next(container);
    ...
    private void btnPayInstallmentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPayInstallmentActionPerformed
        ...
        container.add("Patient Pay Installment JPanel", payInstallmentjp);
        CardLayout layout = (CardLayout) container.getLayout();
        layout.next(container);
